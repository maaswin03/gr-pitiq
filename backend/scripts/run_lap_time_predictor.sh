...
# Complete Lap Time Predictor Pipeline (Standalone Backend)
...
echo "================================================================================"
echo "🏎️  GR PitIQ - LAP TIME PREDICTOR - COMPLETE PIPELINE (STANDALONE)"
echo "================================================================================"
...
if [ "$SKIP_PREPROCESS" = false ]; then
    ...
    if [ ! -f "outputs/lap_time_predictor/engineered_dataset.csv" ]; then
        echo "❌ Error: outputs/lap_time_predictor/engineered_dataset.csv not found"
...
echo "💡 You can reduce n_trials in train_lap_time_predictor.py for faster training"
echo ""
echo "Press Ctrl+C to cancel, or wait 5 seconds to start..."
sleep 5

python3 backend/train/train_lap_time_predictor.py
...
echo ""
echo "   Model (Backend):"
echo "   ├── backend/model/lap_time_predictor.pkl (ensemble only)"
echo "   └── backend/model/metadata/lap_time_predictor.json"
echo ""
echo "   Visualizations:"
echo "   ├── outputs/lap_time_predictor/prediction_comparison.png"
echo "   ├── outputs/lap_time_predictor/error_distribution.png"
echo "   ├── outputs/lap_time_predictor/metrics_comparison.png"
echo "   ├── outputs/lap_time_predictor/feature_importance.png"
echo "   ├── outputs/lap_time_predictor/shap_feature_importance.png"
echo "   ├── outputs/lap_time_predictor/model_enhancement_report.json"
echo "   └── outputs/lap_time_predictor/outlier_removal_stats.json"
echo ""
echo "🎯 Next Steps:"
echo "   1. Review visualizations in outputs/lap_time_predictor/"
