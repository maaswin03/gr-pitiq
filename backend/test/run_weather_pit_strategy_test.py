"""
Standardized Test for Weather Pit Strategy Predictor
...
class WeatherPitStrategyTest(StandardizedModelTester):
    def __init__(self):
        super().__init__(
            model_name='weather_pit_strategy_predictor',
...
if __name__ == "__main__":
    tester = WeatherPitStrategyTest()
    tester.run_full_test(target_col='PIT_DECISION')
